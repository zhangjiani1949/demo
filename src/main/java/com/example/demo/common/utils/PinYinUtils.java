...
public class PinYinUtils {
    ...
    public static void main(String[] args) {
        String str = "智利-车厘子";
        System.out.println("汉字首字母：" + getFirstSpell(str));// TODO 多音字好像不支持
        System.out.println("汉字转化为拼音：" + getPingYin(str));
        System.out.println("汉字转化为拼音：" + getFullSpell(str));
        System.out.println("将字符串转换成ASCII码:" + getCnASCII(str));
        System.out.println("判断是否是汉字：" + str.matches("[\\u4E00-\\u9FA5]+"));
    }
